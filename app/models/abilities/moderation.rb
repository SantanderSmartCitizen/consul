module Abilities
  class Moderation
    ...
    def initialize(user)
      ...
      can :hide, Forum, hidden_at: nil
      cannot :hide, Forum, author_id: user.id

      can :ignore_flag, Forum, ignored_flag_at: nil, hidden_at: nil
      cannot :ignore_flag, Forum, author_id: user.id

      can :moderate, Forum
      cannot :moderate, Forum, author_id: user.id
