...
gamifications = [
	{
		...
		actions_attributes: [
			...
			{
				key: "APOYAR_PROPUESTA", score: 10, process_type: "proposal", operation: "vote", 
			...
			{
				key: "CREAR_PROY_GASTO", score: 20, process_type: "budget_investment", operation: "create", 
			...
			{
				key: "PROC_CREAR_PROPUESTA", score: 20, process_type: "process", operation: "create_proposal", 
			...
			{
				key: "PROC_APOYAR_PROPUESTA", score: 10, process_type: "process", operation: "vote_proposal", 
